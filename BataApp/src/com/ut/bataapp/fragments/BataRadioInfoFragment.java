...
/**
 * Klasse voor het representeren van een een BataRadio-informatiefragment. Retourneert simpelweg de bijbehorende layout/view.
 * Onderdeel van ontwerpproject BataApp.
 * @author Danny Bergsma
 * @version 0.1
 */
public class BataRadioInfoFragment extends SherlockFragment {
	@Override
