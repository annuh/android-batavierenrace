...
public class Sponsor {
	...
	public static ArrayList<Sponsor> getSponsors(){
		...
		sponsors.add(new Sponsor("2", "Defensie", "Beveiliging", "Heel Nederland", "www.defensie.nl", "Organisatie, nieuws, banen en overzichten van taken, lopende operaties en krijgsmachtonderdelen.", "sponsor_mindef"));
		sponsors.add(new Sponsor("3", "Autodrop", "Uitzendbureau", "Heel Nederland", "www.autodrop.nl", "Nieuw van Autodrop: centre filled! Vloeibare drop en snoep in verschillende smaken… Heb je ze al geproefd? Absurd lekker!", "sponsor_autodrop"));
